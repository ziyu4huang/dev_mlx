...
export const Scene05_BookBrowser: React.FC = () => {
        ...
        >
          ...
          <div
            style={{
              ...
              gap: 30,
              paddingBottom: 20,
              opacity: interpolate(frame, [320, 360], [0, 1], { extrapolateLeft: "clamp" }),
            }}
          >
            {["Character Registry", "Chapter Status", "Voice Pool", "Bulk Production"].map(
              (feat) => (
                <div
                  key={feat}
                  style={{
