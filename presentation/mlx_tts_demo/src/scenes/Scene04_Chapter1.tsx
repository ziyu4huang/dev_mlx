...
import { chapter1Segments, emotionColors, characterColors } from "../data/chapters";

const TOTAL_FRAMES = 2700; // 90 seconds
const SEGMENT_COUNT = chapter1Segments.length;
const FRAMES_PER_SEGMENT = TOTAL_FRAMES / SEGMENT_COUNT;

export const Scene04_Chapter1: React.FC = () => {
  ...
  return (
    <AbsoluteFill>
      <GradientBackground glowColor="#a78bfa">
        <Audio src={staticFile("audio/chapter-001.flac")} />
        ...
        >
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
              ...
              <div>
                ...
                <div style={{ fontSize: 13, color: THEME.muted }}>
                  煙火人間 — Chapter 1 · Live Audio Demo
                </div>
              </div>
            </div>
          ...
          >
            ...
            {currentSegIdx < SEGMENT_COUNT - 1 && (
              ...
              >
                {chapter1Segments[currentSegIdx + 1].text}
              </div>
            )}
          </div>
        </AbsoluteFill>
